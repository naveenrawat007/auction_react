...
export default class PropertyPending extends Component{
  ...
  getPropertiesList = () => {
    ...
    let url = process.env.REACT_APP_BACKEND_BASE_URL + "/properties?status=Pending&search_str=" + this.state.search_str + "&page=" + this.state.page
    fetch(url, {
      method: "GET",
      headers: {
  ...
  getNextPage = (current_page, total_pages) => {
    ...
    <div className="profile-setting">
      <div className="container custom_container buy_tab px-0 loading-spinner-parent">
        ...
        <h3 className="font-blue">Pending Properties</h3>
        {
