...
export default class PropertyPostAuction extends Component{
  _isMounted = false
  ...
  getPropertiesList = () => {
    ...
    let url = process.env.REACT_APP_BACKEND_BASE_URL + "/properties?status=Post Auction&search_str=" + this.state.search_str + "&page=" + this.state.page
    fetch(url, {
      method: "GET",
      headers: {
