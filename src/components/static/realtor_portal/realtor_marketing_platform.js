    ...
    return(
      <div className="tab-pane show active">
        <p>
          ...
          Auctions are not for most retail properties that don’t need any work, unless the Seller is very motivated and needs to sell quick?
          ...
          <Accordion.Collapse eventKey="0">
            <div>
              <p>
                ...
                That’s right, our Real Estate Investor platform doesn’t cost Sellers or Realtors any money to use this site.  At this current time we are also offering this site for FREE to all bidders for a limited time, and then will charge the Highest Bidder a reasonable Internet Transaction Fee.
                ...
                Have an active license with the Texas Real Estate Commission
                Have your Seller execute a Listing Agreement with the Exclusive Right to Sell their property
                Seller to execute an (Amendment to Listing) that gives you the right to Auction their property at AuctionMyDeal.com.
                ...
                Get contractor(s) or put together estimated rehab costs. Download FREE Excel Estimate of Rehab Costs)   This will make your deal more credible, unless it’s land or needs to be torn down.
                Provide Market Comps, list of rehab #’s and Advise your client (Seller) what their Minimum Selling Price and Maximum (Buy Now Price) should be. The Buy Now Price can not be more than any listed price on MLS or other sites where advertised.
                Once you and your Seller believe their property is a good candidate to Auction, then Register or login to your Free account at AuctionMyDeal.com.
                Go to SELL
                Click Auction Participation Agreement, click that you are a real estate agent submitting listing, upload your Executed Listing Agreement, Listing Addendum, Sellers Disclosure, Lead Based Paint & HOA Addendum. Then check all other boxes to confirm your acceptance, and be able to submit your property.  (Click here if you have any Questions?)
                Fill in Property Details, Deal Analysis estimated numbers, upload your estimated ARV proof (Top 3 Sold Comps), description of repairs (contractor estimate or Free Excel Estimate of Rehab Costs), auction details, upload at least 10 to 20 pictures and a video of the property.
                Click Submit, and your listing will be under review until we approve it for Auction or email you why your property doesn’t meet our terms and conditions to Auction.
                ...
                The following statement must be added to the MLS under Agent Remarks:
                ...
                10. You are required to offer the same commission on MLS to any Real Estate agent licensed by TREC (Texas Real Estate Commission) who has submitted the highest accepted Bid. Listing Agents are required to list what commission they are offering under disclosures.
                11. Listing agent & Seller agree to pay $997 if they withdraw their property off the market after Live Online Bidding has started, or if they don’t accept their Minimum Selling price when the countdown of the auction ends.
                12. There is a Post Bidding time frame of up to 7 days for properties that did not get any bids during Live Online Bidding.
