...
export default class AdminChatList extends Component{
	constructor(props){
    super(props);
		this.state = {
      loaded: false,
  ...
  componentDidMount () {
	...
	getChatRoomsList = () => {
		let url = process.env.REACT_APP_BACKEND_BASE_URL + "/admin/chat_rooms?search_str=" + this.state.search_str + "&page=" + this.state.page
    fetch(url, {
      method: "GET",
      headers: {
