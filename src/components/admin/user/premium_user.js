...
export default class PremiumUserList extends Component{
  _isMounted = false
  ...
  getUsersList = () => {
    ...
    let url = process.env.REACT_APP_BACKEND_BASE_URL + "/admin/users?status=Premium&search_str=" + this.state.search_str + "&page=" + this.state.page
    fetch(url, {
      method: "GET",
      headers: {
