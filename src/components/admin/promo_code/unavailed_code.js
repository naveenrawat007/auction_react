...
export default class UnavailedCodeList extends Component{
  _isMounted = false
  ...
  getPromoCodeList = () => {
    ...
    let url = process.env.REACT_APP_BACKEND_BASE_URL + "/admin/promo_codes?status=false&search_str=" + this.state.search_str + "&page=" + this.state.page
    fetch(url, {
      method: "GET",
      headers: {
