...
export default class AllCodeList extends Component{
  _isMounted = false
  ...
  getPromoCodeList = () => {
    ...
    let url = process.env.REACT_APP_BACKEND_BASE_URL + "/admin/promo_codes?search_str=" + this.state.search_str + "&page=" + this.state.page
    fetch(url, {
      method: "GET",
      headers: {
