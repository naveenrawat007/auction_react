...
export default class ListBuyNowProperty extends Component{
  _isMounted = false
  ...
  getPropertiesList = () => {
    let url = process.env.REACT_APP_BACKEND_BASE_URL + "/user/properties?type=buy_now&search_str=" + this.state.search_str + "&page=" + this.state.page
    fetch(url, {
      method: "GET",
      headers: {
        ...
        <div className="profile-form">
          <div className="profile-form-in">
            <ul className="nav nav-pills nav-properties" role="tablist">
              ...
              <li className="nav-item">
                <Link to="/user/property/buy_now" className="nav-link active " data-toggle="pill" href="#propertyPosted">List of Buy Now</Link>
              </li>
            </ul>
