...
export default class ListBidProperty extends Component{
  _isMounted = false
  ...
  getPropertiesList = () => {
    let url = process.env.REACT_APP_BACKEND_BASE_URL + "/user/properties?type=bid&search_str=" + this.state.search_str + "&page=" + this.state.page
    fetch(url, {
      method: "GET",
      headers: {
        ...
        <div className="profile-form">
          <div className="profile-form-in">
            ...
            <ul className="nav nav-pills nav-properties" role="tablist">
              ...
              <li className="nav-item">
                <Link to="/user/property/bids" className="nav-link active " data-toggle="pill" href="#propertyPosted">List of Bids</Link>
              </li>
              <li className="nav-item">
